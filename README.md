...
6. 新增 生产任务 所有列表 商务+生产 状态选择 UI组件
7. 重构 tabbar 减少dom操作 优化路由 响应速度
8. 新增 生产任务 状态改变 确认提示
9. 修改 生产任务 进度条 粗细
...
```
1. 新增 TS语法支持 改写 utils函数为typescript语法
2. 修改 生产任务 列表页 样式
3. 新增 生产任务 列表页 状态 UI
...
1. 新增 bom模块 UI
2. 新增 bom模块 数据初始化接口
3. 新增 bom模块 提交零件接口并刷新表格
4. 新增 bom模块 同步数据接口
5. 新增 物料模块 搜索接口 + 数据展示 + 提示
6. 新增 物料模块 废料模块 数据接口 +  展示UI
7. 新增 物料模块 废料模块 使用接口
8. 新增 物料模块 废料模块 搜索接口
9. 新增 物料模块 废料模块 编辑接口
10. 新增 物料模块 废料模块 bom接口
11. 新增 物料模块 临时物料 数据接口 +  展示UI
